...
export function GetBoardTasks(arg1:string):Promise<Array<board.TaskCard>>;

export function CreateBoardTask(arg1:string,arg2:board.TaskCard):Promise<board.TaskCard>;

export function GetBoardTask(arg1:string,arg2:string):Promise<board.TaskCard>;

export function UpdateBoardTask(arg1:string,arg2:board.TaskCard):Promise<void>;

export function DeleteBoardTask(arg1:string,arg2:string):Promise<void>;

export function MoveBoardTask(arg1:string,arg2:string,arg3:board.Event):Promise<board.TransitionResult>;

export function SaveBoardPlan(arg1:string,arg2:string,arg3:board.Plan):Promise<void>;

export function GetBoardPlan(arg1:string,arg2:string):Promise<board.Plan>;

export function SyncBoard(arg1:string):Promise<void>;
...
export function ApprovePlan(arg1:string,arg2:string,arg3:number):Promise<void>;
...
export function StartOrchestration(arg1:string):Promise<void>;

export function StopOrchestration(arg1:string):Promise<void>;

export function GetOrchestrationStatus(arg1:string):Promise<backend.OrchestrationStatus>;

export function GenerateSubTickets(arg1:string,arg2:string,arg3:number):Promise<void>;
