const de = {
  ...
  footer: {
    ...
    updateApply: 'Update v{version} installieren',
  ...
  settings: {
    ...
    keepAliveDesc: 'Sendet automatisch eine Nachricht an Claude, wenn das Token-Fenster ausläuft. Änderungen werden beim nächsten Start wirksam.',
    keepAliveInterval: 'Intervall (Minuten)',
    keepAliveMessage: 'Nachricht',
    statusLine: 'Claude Statusline',
    statusLineDesc: 'Aktiviert eine Statuszeile in Claude Code Panes (Modell, Kontext-%, Kosten). Schreibt in ~/.claude/settings.json.',
    statusLineConflict: 'Achtung: Eine externe statusLine-Konfiguration wurde erkannt und wird beim Speichern überschrieben.',
    statusLineExtended: 'Erweitert — 2-zeilig mit Verzeichnis',
    statusLineModel: 'Modell-Name',
    statusLineContext: 'Kontext-Auslastung %',
    statusLineCost: 'Kosten ($)',
    statusLineDuration: 'Dauer',
    backgroundAgents: 'Hintergrund-Agenten',
    bgDesc: 'Optionale Agenten die bei jedem Commit automatisch im Hintergrund laufen.',
    bgReviewEnabled: 'Automatisches Review bei Commit',
    bgReviewTool: 'Review-Tool',
    bgReviewModel: 'Review-Modell',
    bgReviewPrompt: 'Review-Prompt',
    bgReviewPromptHint: '{diff} wird durch den Commit-Diff ersetzt',
    bgReviewPromptDefault: 'Standard',
    bgTestEnabled: 'Automatische Tests bei Commit',
    bgTestCommand: 'Test-Befehl',
    bgTestPlaceholder: 'z.B. go test ./...',
    reset: 'Standard',
    cancel: 'Abbrechen',
    save: 'Speichern',
  },
