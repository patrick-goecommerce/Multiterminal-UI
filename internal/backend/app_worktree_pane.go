...
// mainRepoRoot, gitToplevel and worktreeEnvVars moved to internal/gitx and
// internal/launch, so the daemon can answer the same questions. The names in
// this package still work; see launch_delegate.go.
