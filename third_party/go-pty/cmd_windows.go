...
func (c *Cmd) start() error {
	...
	// MTUI patch: CreateProcess's own process handle was never closed, so every
	// start leaked one handle and kept the dead process object (and its PID)
	// alive for the life of the calling process. os.FindProcess opened a
	// handle of its own above; this one has done its job either way.
	defer func() {
